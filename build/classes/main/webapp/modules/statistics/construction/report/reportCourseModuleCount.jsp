...
<body class="ovreflow1" style="width:100%;height:100%;">
	...
	<div id="main" style="height:450px; display: none"></div>
   	<script type="text/javascript">
    	...
    	var totalCount = '模块数总量：' + ${resultList[2]};
   		        ...
   		        feature : {
   		            ...
   		            saveAsImage : {show: true},
   		         	myTool : {
	   	                 ...
	   	                 onclick : function (){
	   	                 	var param = parent.generateExportData(titleArray,dataArray)+",模块数总量:${resultList[2]}";
 	                 	 	window.location = path+'/export/download.action?value='+param+'&title=各门课程模块数分布统计';
 	                     }
 	               }
   		        }
   		    },
