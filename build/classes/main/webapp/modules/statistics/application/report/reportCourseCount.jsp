   	            ...
   	            feature : {
   	                ...
   	                saveAsImage : {show: true},
   	             	myTool : {
	   	                 ...
	   	                 onclick : function (){
	   	                 	var param = parent.generateExportData(titleArray,dataArray)+",课程访问总数:${resultList[2]}";
	                 	 	window.location = path+'/export/download.action?value='+param+'&title=课程访问次数统计';
	                     }
	                }
   	            }
   	        },
