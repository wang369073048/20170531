...
<body class="ovreflow1" style="width: 100%; height: 100%;">
	...
	<script type="text/javascript">
		...
		var total = '资源素材使用总次数：'+${resultList[3]};
		    ...
		    toolbox: {
	            ...
	            feature : {
	                ...
	                myTool : {
  	   	                 ...
  	   	                 onclick : function (){
  	   	                 	var param = parent.generateExportData(titleArray,dataArray)+",资源素材使用总次数:${resultList[3]}";
  	                 	 	window.location = path+'/export/download.action?value='+param+'&title=资源素材使用总次数统计';
  	                     }
  	                }
	            }
	        },
