	...
	<div id="main" style="height:450px;"></div>
   	<script type="text/javascript">
    	...
    	var dataArray = ${resultList[1]};
	   	var totalCount = '增长率：' + ${resultList[2]}; 
   		        ...
   		        feature : {
   		            ...
   		            saveAsImage : {show: true},
   		         	myTool : {
     	                 ...
     	                 onclick : function (){
     	                 	var param = parent.generateExportData(titleArray,dataArray)+",注册用户增长率:"+${resultList[2]}.substring(0,${resultList[2]}.length-1)+"%25";
                   	 	window.location = path+'/export/download.action?value='+param+'&title=注册用户增长率统计';
                       }
                 	}
   		        }
   		    },
