...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/modules/sysMenu/js/sysMenuTreeAssignRole.js"></script>
...
<body>
	...
	<div>
		<a href="javascript:assignRoleMenu();" class="easyui-linkbutton" iconCls="icon-ok">确定</a>
