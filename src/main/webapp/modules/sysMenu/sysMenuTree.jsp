...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/modules/sysMenu/js/sysMenuTree.js"></script>
</head>
...
<div class="main">
	<div class="main_bigbox1">
		...
		<div class="main_rightMenu">
			<iframe id="gridframe" scrolling="auto" marginheight="0"  marginwidth="0" frameborder="0" height="100%" width="100%" src="">
			</iframe>
		</div>
	</div>
</div>
