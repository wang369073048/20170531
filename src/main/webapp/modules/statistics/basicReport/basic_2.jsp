	...
	<div class="main_bigbox">
		<div class="leftstatus">
			<div class="menu-status">
				<ul>
					<li><a href="javascript:changeStatus(1);" class="sbz">申报中</a> </li>
					<li class="on"><a href="###" class="ylx">已立项</a> </li>
					<li><a href="javascript:changeStatus(3);" class="yys">已验收</a> </li>
				</ul>
			</div>
		</div>
		
		<div class="main_rightcontent" style="background-color:#F3F1F1!important;margin-left:90px; overflow:auto;">
			<div class="basic-search">
				<div class="basic-search-div">
					<form id="searchForm" method="post" action="${pageContext.request.contextPath}/report_basic/reportBasic.action?status=2">
			...
			<table width="98%" align="center" bgcolor="#FFFFFF" style="border: solid thin #DED9D8" cellpadding="0" cellspacing="0">
				<tr height="40" bgcolor="#F7F7F6">
					...
					<td align="left" width="15%">&nbsp;&nbsp;<font color="blue">
						<a href="<%=request.getContextPath() %>/report_basic/reportBasic.action?status=2&order=fullname" style="color: blue">名称</a></font>
					</td>
					<td align="left" width="10%">&nbsp;&nbsp;<font color="blue">
						<a href="<%=request.getContextPath() %>/report_basic/reportBasic.action?status=2" style="color: blue">资源库编号</a></font>
					</td>
