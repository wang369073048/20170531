		...
		<div class="leftstatus">
			<div class="menu-status">
				<ul>
					...
					<li class="on"><a href="###" class="yys">已验收</a> </li>
				</ul>
			</div>
		</div>
		...
		<div class="main_rightcontent" style="background-color:#F3F1F1!important;margin-left:90px; overflow:auto;" id="div_sbz">
			<div class="basic-search">
				<div class="basic-search-div">
					<form id="searchForm" method="post" action="${pageContext.request.contextPath}/report_basic/reportBasic.action?status=3">
			...
			<table width="98%" align="center" bgcolor="#FFFFFF" style="border: solid thin #DED9D8" cellpadding="0" cellspacing="0">
				<tr height="40" bgcolor="#F7F7F6">
					...
					<td align="left" width="15%">&nbsp;&nbsp;<font color="blue">
						<a href="<%=request.getContextPath() %>/report_basic/reportBasic.action?status=3&order=fullname" style="color: blue">名称</a></font>
					</td>
					<td align="left" width="10%">&nbsp;&nbsp;<font color="blue">
						<a href="<%=request.getContextPath() %>/report_basic/reportBasic.action?status=3" style="color: blue">资源库编号</a></font>
					</td>
