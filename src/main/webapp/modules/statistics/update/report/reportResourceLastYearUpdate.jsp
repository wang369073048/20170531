   		        ...
   		        feature : {
   		            ...
   		            saveAsImage : {show: true},
   		         	myTool : {
     	                 ...
     	                 onclick : function (){
     	                 	var param = parent.generateExportData(titleArray,dataArray)+",同比上一年资源更新率:"+${resultList[2]}.substring(0,${resultList[2]}.length-1)+"%25";
                   	 	window.location = path+'/export/download.action?value='+param+'&title=同比上一年资源更新率统计';
                       }
                   }
   		        }
   		    },
