...
<body class="ovreflow1" style="width:100%;height:100%;">
	<div id="main" style="height:450px;"></div>
   	<script type="text/javascript">
    	...
    	var totalCount = '用户总数：'+${resultList[3]};
   	            ...
   	            feature : {
   	                ...
   	                saveAsImage : {
   	             	...
   	             	myTool : {
	   	                 ...
	   	                 onclick : function (){
	   	                 	var param = parent.generateExportData(titleArray,dataArray)+",用户总量:${resultList[3]}";
	                 	 	window.location = path+'/export/download.action?value='+param+'&title=用户数量统计统计';
	                     }
	               }
   	            }
   	        },
