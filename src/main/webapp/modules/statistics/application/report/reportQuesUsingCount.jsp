   	            ...
   	            feature : {
   	                ...
   	                saveAsImage : {
   	            	 ...
   	            	 myTool : {
  	   	                 ...
  	   	                 onclick : function (){
  	   	                 	var param = parent.generateExportData(titleArray,dataArray)+",题库题目使用总次数:${resultList[3]}";
  	                 	 	window.location = path+'/export/download.action?value='+param+'&title=题库题目使用总次数统计';
  	                     }
  	                	}
   	            }
   	        },
