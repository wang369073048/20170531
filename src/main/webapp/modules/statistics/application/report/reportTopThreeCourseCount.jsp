...
<body class="ovreflow1" style="width:100%;height:100%;">
	<div id="main" style="height:450px;"></div>
   	<script type="text/javascript">
		...
		var total = '各个课程访问总数：'+${resultList[2]}
   	            ...
   	            feature : {
   	                ...
   	                saveAsImage : {show: true},
   	             	myTool : {
	   	                 ...
	   	                 onclick : function (){
	   	                 	var param = parent.generateExportData(titleArray,dataArray)+",各个课程访问总数:${resultList[2]}";
	                 	 	window.location = path+'/export/download.action?value='+param+'&title=各个课程访问情况（前三）统计';
	                     }
	                }
   	            }
   	        },
