...
english:{validator: function (value, param) {
...
userName:{validator: function (value, param) {
	...
	message: '只能输入4-20位的英文或数字！'
},

url:{validator:function(_363){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["日","一","二","三","四","五","六"],months:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_3c2){
